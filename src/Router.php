...
class Router
{
    private $routes = [
		...
		'/finance/api/search_orders'      => '/modules/finance/api/search_orders.php',
		'/finance/api/get_linked_orders'  => '/modules/finance/api/get_linked_orders.php',
		'/finance/api/link_order'         => '/modules/finance/api/link_order.php',
		'/finance/api/unlink_order'       => '/modules/finance/api/unlink_order.php',
		...
		'/counterparties/api/forward_message'     => '/modules/counterparties/api/forward_message.php',
		'/counterparties/api/get_team_messages'   => '/modules/counterparties/api/get_team_messages.php',
		'/counterparties/api/send_team_message'   => '/modules/counterparties/api/send_team_message.php',
		'/counterparties/api/get_team_state'      => '/modules/counterparties/api/get_team_state.php',
		...
		'/demand/api/get_linked_docs'  => '/modules/demand/api/get_linked_docs.php',
		'/demand/api/create_document'  => '/modules/demand/api/create_document.php',
		'/demand/api/delete_demands'   => '/modules/demand/api/delete_demands.php',
		...
		'/customerorder/api/get_product_prices'   => '/modules/customerorder/api/get_product_prices.php',
		'/customerorder/api/get_linked_docs'      => '/modules/customerorder/api/get_linked_docs.php',
		'/customerorder/api/get_order_shipments'  => '/modules/customerorder/api/get_order_shipments.php',
		'/customerorder/api/save_order_delivery'  => '/modules/customerorder/api/save_order_delivery.php',
		...
		'/customerorder/api/unlink_document'      => '/modules/customerorder/api/unlink_document.php',
			'/customerorder/api/delete_orders'        => '/modules/customerorder/api/delete_orders.php',
		...
		'/novaposhta/api/delete_scansheet'    => '/modules/novaposhta/api/delete_scansheet.php',
			'/novaposhta/api/close_scansheet'     => '/modules/novaposhta/api/close_scansheet.php',
		...
		'/novaposhta/api/scan_for_registry'     => '/modules/novaposhta/api/scan_for_registry.php',
		...
		// History (universal)
		'/history/api/get' => '/modules/history/api/get.php',
		...
		'/print/api/generate_demand_pdf' => '/modules/print/api/generate_demand_pdf.php',
		'/print/api/generate_pack'       => '/modules/print/api/generate_pack.php',
		'/print/api/generate_pack_bulk'  => '/modules/print/api/generate_pack_bulk.php',
		'/print/api/get_pack'            => '/modules/print/api/get_pack.php',
		'/print/api/get_pack_profiles'   => '/modules/print/api/get_pack_profiles.php',
		'/print/api/save_pack_profile'   => '/modules/print/api/save_pack_profile.php',
		'/print/api/delete_pack_profile' => '/modules/print/api/delete_pack_profile.php',
		'/print/queue'                   => '/modules/print/queue.php',
		'/print/api/queue'               => '/modules/print/api/queue.php',
		'/print/api/queue_add'           => '/modules/print/api/queue_add.php',
		'/print/api/queue_remove'        => '/modules/print/api/queue_remove.php',
		'/print/api/queue_clear'         => '/modules/print/api/queue_clear.php',
		'/print/api/queue_count'             => '/modules/print/api/queue_count.php',
		'/print/api/generate_pack_for_orders' => '/modules/print/api/generate_pack_for_orders.php',
