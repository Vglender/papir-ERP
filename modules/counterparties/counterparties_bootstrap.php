...
require_once __DIR__ . '/../shared/GmailSmtpService.php';
require_once __DIR__ . '/../shared/TelegramBotService.php';
require_once __DIR__ . '/../shared/MessageDispatchService.php';
